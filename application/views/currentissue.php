                        ...
                        <ul>
                            <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/it_service/slide1.jpg" data-rotate="0" data-saveperformance="off" data-title="Impact Factor 6.79" data-description="">
                                ...
                                <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                     ...
                                     style="z-index: 6; white-space: nowrap;">Articles from 56 + Countries</div>
                                <!-- LAYER NR. 3 -->
                                <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 7; white-space: nowrap;">International Journal of Pharmaceutical Research and Applications</div>
                            </li>
                            <li data-index="rs-181" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/it_service/slide2.jpg" data-rotate="0" data-saveperformance="off" data-title="Refereed Journal" data-description="">
                                ...
                                <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                     ...
                                     data-responsive_offset="on"
                                     data-elementdelay="0.05"
                                     style="z-index: 6; white-space: nowrap;">Publish Your Article Today</div>
                                <!-- LAYER NR. 3 -->
                                <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                            ...
                            <li data-index="rs-18" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/it_service/slide3.jpg" data-rotate="0" data-saveperformance="off" data-title="Peer Reviewed Journal" data-description="">
                                <!-- MAIN IMAGE -->
                                ...
                                <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                     ...
                                     data-responsive_offset="on"
                                     data-elementdelay="0.05"
                                     style="z-index: 6; white-space: nowrap;">IJPRA Impact Factor 6.79</div>
                                <!-- LAYER NR. 3 -->
                                <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                     id="slide-18-layer-4"
                                     data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 about_cont_blog" style="background:#ebebeb;">
                    <div class="full text_align_left">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-check-circle"></i>Fast Track Publication within 48 Hours <!-- (Guaranteed) after receiving of Publication Fee &amp; Copyright Form. --></li>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30">
                  ...
                  <h4 class="theme_color">Best Pharmacy Journal</h4>
                  <p>Perspiciatis eos quos totam cum minima aut!</p>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30">
                  ...
                  <h4 class="theme_color">Publish within 48 hrs</h4>
                  <p>Perspiciatis eos quos totam cum minima aut!</p>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30 margin_0">
                  ...
                  <h4 class="theme_color">Peer Reviewed Refereed Journal</h4>
                  <p>Perspiciatis eos quos totam cum minima aut!</p>
                </div>
              </div>
            </div> -->
                    ...
                    <div class="price_table row" style="margin-top: 0;">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="price_table_inner margin_bottom_30">
                                <div class="price_head text_align_center">
                                    ...
                                    <!-- <p>Submission Last Date</p> -->
                                </div>
                                <div class="price_contant">
                                    <div class="center">
                                        <p class="price_amount"><span class="price_no">24x7</span>WORKING </p>
                                    </div>
                                ...
                                <div class="price_bottom">
                                    <div class="center"> <a href="submit-manuscript.html" class="btn dark_gray_bt">Submit Today</a> </div>
                                </div>
                            </div>
                        </div>
                        <!-- end price table one -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 price_table_active">
                            <div class="row">
                                <div class="price_table_inner margin_bottom_30">
                                    ...
                                    <div class="price_contant">
                                        <div class="center">
                                            <p class="price_amount">Within <span class="price_no">24</span>  Hours </p>
                                        </div>
                                        <!-- <div class="price_cont text_align_center">
                                          <p>Fast service</p>
                                          <p>Safe payments</p>
                                    ...
                                    <div class="price_bottom">
                                        <div class="center"> <a href="submit-manuscript.html" class="btn main_bt">Submit Today</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="price_table_inner">
                                <div class="price_head text_align_center">
                                    <h5>E-Certificates</h5>
                                    <!-- <p>Within 04 Hours</p> -->
                                </div>
                                <div class="price_contant">
                                    <div class="center">
                                        <p class="price_amount">Within <span class="price_no">04</span>Hours</p>
                                    </div>
                                    <!-- <div class="price_cont text_align_center">
                                      <p>Fast service</p>
                                      <p>Safe payments</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"> <a href="author-guidelines.html"><img class="img-responsive" src="images/it_service/1.jpg" alt=""></a> </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"><a href="submit-manuscript.html"> <img class="img-responsive" src="images/it_service/2.jpg" alt=""></a> </div>
                        <div class="product_detail_btm">
                            <div class="center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
								    ...
								    <div class="product_img"><a href="current-issue6f14.html?issueid=34"><img class="img-responsive" src="images/it_service/3.jpg" alt=""></a> </div>
                                    <div class="product_detail_btm">
                                      <div class="center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"><a href="editorial-board.html"><img class="img-responsive" src="images/it_service/4.jpg" alt=""></a> </div>
                        <div class="product_detail_btm">
                            <div class="center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"><a href="membership.html"> <img class="img-responsive" src="images/it_service/5.jpg" alt=""></a> </div>
                        <div class="product_detail_btm">
                            <div class="center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"> <a href="peer-review-process.html"><img class="img-responsive" src="images/it_service/6.jpg" alt=""></a> </div>
                        <div class="product_detail_btm">
                            <div class="center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"> <a href="pay-fees.html"><img class="img-responsive" src="images/it_service/7.jpg" alt=""> </a></div>
                        <div class="product_detail_btm">
                            <div class="center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"><a href="copyright-form.html"><img class="img-responsive" src="images/it_service/8.jpg" alt=""></a> </div>
                        <div class="product_detail_btm">
                            <div class="center">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                            ...
                            <div class="text_align_right">
                                <p class="counter-heading text_align_right">Issue Released</p>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                            ...
                            <div class="text_align_right">
                                <p class="counter-heading text_align_right">Indexing</p>
                            </div>
                            <h5 class="counter-count">7</h5>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                            <div class="text_align_right"><i class="fa fa-users"></i></div>
                            <div class="text_align_right">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                            <div class="text_align_right"><i class="fa fa-book"></i></div>
                            <div class="text_align_right">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="testimonial-container">
                                        <div class="testimonial-content"> Best Journal forever. All work completed within given time frame. Keep It up </div>
                                        <div class="testimonial-photo"> <img src="images/loaders/loader_1.png" class="img-responsive" alt="#" width="150" height="150"> </div>
                                ...
                                <div class="carousel-item">
                                    <div class="testimonial-container">
                                        <div class="testimonial-content"> I am happy with the time frame of publication of articles. Best Peer reviewed Journal.</div>
                                        <div class="testimonial-photo"> <img src="images/loaders/loader_1.png" class="img-responsive" alt="#" width="150" height="150"> </div>
                                        <div class="testimonial-meta">
                                            <h4>Sarahu Nagarazan</h4>
                                            <!-- <span class="testimonial-position">CFO, Tech NY</span> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="testimonial-container">
                                        <div class="testimonial-content"> You guys rock! Thank you for making it painless, pleasant and most of all hassle free! I wish I would have thought of it first.I am really satisfied with  service. </div>
                                        <div class="testimonial-photo"> <img src="images/loaders/loader_1.png" class="img-responsive" alt="#" width="150" height="150"> </div>
                                        <div class="testimonial-meta">
                                            <h4>Ms. Harpreet Kaur</h4>
                                            <!-- <span class="testimonial-position">CFO, Tech NY</span> -->
                                        </div>
                                    </div>
                                </div>
